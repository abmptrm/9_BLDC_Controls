...
void ui_MainScreen_screen_init(void)
{
    ...
    ui_Button29 = lv_btn_create(ui_MainScreen);
    lv_obj_set_width(ui_Button29, 80);
    lv_obj_set_height(ui_Button29, 50);
    lv_obj_set_x(ui_Button29, 187);
    lv_obj_set_y(ui_Button29, 103);
    lv_obj_set_align(ui_Button29, LV_ALIGN_CENTER);
    lv_obj_set_style_radius(ui_Button29, 5, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui_Button29, lv_color_hex(0xE5383B), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_Button29, 255, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_Button31 = lv_btn_create(ui_MainScreen);
    lv_obj_set_width(ui_Button31, 80);
    lv_obj_set_height(ui_Button31, 50);
    lv_obj_set_x(ui_Button31, 101);
    lv_obj_set_y(ui_Button31, 103);
    lv_obj_set_align(ui_Button31, LV_ALIGN_CENTER);
    lv_obj_set_style_radius(ui_Button31, 5, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui_Label11, "RUN");

    ui_Label12 = lv_label_create(ui_MainScreen);
    lv_obj_set_width(ui_Label12, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_Label12, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_Label12, 188);
