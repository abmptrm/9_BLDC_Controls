...
void ui_BLDC_8_screen_init(void)
{
    ...
    lv_obj_set_x(ui_LabelSpeed8, -68);
    lv_obj_set_y(ui_LabelSpeed8, -13);
    ...
    if(lv_slider_get_mode(ui_SliderSpeed8) == LV_SLIDER_MODE_RANGE) lv_slider_set_left_value(ui_SliderSpeed8, 0,
                                                                                                 LV_ANIM_OFF);
    lv_obj_set_width(ui_SliderSpeed8, 250);
    lv_obj_set_height(ui_SliderSpeed8, 14);
    lv_obj_set_x(ui_SliderSpeed8, -63);
    lv_obj_set_y(ui_SliderSpeed8, 69);
