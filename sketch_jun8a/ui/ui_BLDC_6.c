...
void ui_BLDC_6_screen_init(void)
{
    ...
    lv_obj_set_x(ui_LabelSpeed6, -57);
    lv_obj_set_y(ui_LabelSpeed6, -8);
    ...
    if(lv_slider_get_mode(ui_SliderSpeed6) == LV_SLIDER_MODE_RANGE) lv_slider_set_left_value(ui_SliderSpeed6, 0,
                                                                                                 LV_ANIM_OFF);
    lv_obj_set_width(ui_SliderSpeed6, 250);
    lv_obj_set_height(ui_SliderSpeed6, 14);
    lv_obj_set_x(ui_SliderSpeed6, -65);
    lv_obj_set_y(ui_SliderSpeed6, 69);
    ...
    lv_obj_add_event_cb(ui_Switch12, ui_event_Switch12, LV_EVENT_ALL, NULL);
