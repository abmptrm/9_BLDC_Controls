...
void ui_BLDC_2_screen_init(void)
{
    ...
    lv_obj_set_x(ui_BLDC2, -57);
    lv_obj_set_y(ui_BLDC2, -102);
    ...
    lv_obj_set_x(ui_LabelSpeed2, -58);
    lv_obj_set_y(ui_LabelSpeed2, -7);
    ...
    if(lv_slider_get_mode(ui_SliderSpeed2) == LV_SLIDER_MODE_RANGE) lv_slider_set_left_value(ui_SliderSpeed2, 0,
                                                                                                 LV_ANIM_OFF);
    lv_obj_set_width(ui_SliderSpeed2, 250);
    lv_obj_set_height(ui_SliderSpeed2, 14);
    lv_obj_set_x(ui_SliderSpeed2, -58);
    lv_obj_set_y(ui_SliderSpeed2, 73);
