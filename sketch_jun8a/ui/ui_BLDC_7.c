...
void ui_BLDC_7_screen_init(void)
{
    ...
    lv_obj_set_x(ui_BLDC7, -62);
    lv_obj_set_y(ui_BLDC7, -106);
    ...
    lv_obj_set_x(ui_LabelSpeed7, -65);
    ...
    if(lv_slider_get_mode(ui_SliderSpeed7) == LV_SLIDER_MODE_RANGE) lv_slider_set_left_value(ui_SliderSpeed7, 0,
                                                                                                 LV_ANIM_OFF);
    lv_obj_set_width(ui_SliderSpeed7, 250);
    lv_obj_set_height(ui_SliderSpeed7, 14);
    lv_obj_set_x(ui_SliderSpeed7, -66);
    lv_obj_set_y(ui_SliderSpeed7, 69);
