...
void ui_BLDC_4_screen_init(void)
{
    ...
    lv_obj_add_state(ui_Switch8, LV_STATE_CHECKED);       /// States
    ...
    lv_obj_set_style_bg_color(ui_Switch8, lv_color_hex(0xFF3F3F), LV_PART_INDICATOR | LV_STATE_CHECKED);
    lv_obj_set_style_bg_opa(ui_Switch8, 255, LV_PART_INDICATOR | LV_STATE_CHECKED);
