...
lv_obj_t * ui_Label22;
lv_obj_t * ui_Label23;
void ui_event_ButtonKembali9(lv_event_t * e);
lv_obj_t * ui_ButtonKembali9;
lv_obj_t * ui_LabelKembali9;
lv_obj_t * ui_Keyboard1;
lv_obj_t * ui_ContainerMsgBox10;
lv_obj_t * ui_Panel12;
lv_obj_t * ui_Label80;
...
void ui_event_Switch1(lv_event_t * e)
{
    ...
    lv_obj_t * target = lv_event_get_target(e);
    if(event_code == LV_EVENT_CLICKED) {
        _ui_label_set_property(ui_Label1, _UI_LABEL_PROPERTY_TEXT, "INI EDIT ON/OFF");
    }
}
void ui_event_ButtonSimpan(lv_event_t * e)
{
...
void ui_event_Button18(lv_event_t * e)
{
    ...
    lv_obj_t * target = lv_event_get_target(e);
    if(event_code == LV_EVENT_CLICKED) {
        _ui_state_modify(ui_ContainerMsgBox3, LV_STATE_CHECKED, _UI_MODIFY_STATE_ADD);
    }
}
void ui_event_ButtonKembali4(lv_event_t * e)
{
...
void ui_event_ButtonKembali9(lv_event_t * e)
{
    ...
    lv_obj_t * target = lv_event_get_target(e);
    if(event_code == LV_EVENT_RELEASED) {
        _ui_flag_modify(ui_ContainerMsgBox10, LV_OBJ_FLAG_HIDDEN, _UI_MODIFY_FLAG_REMOVE);
    }
}
void ui_event_Button31(lv_event_t * e)
{
    ...
    lv_obj_t * target = lv_event_get_target(e);
    if(event_code == LV_EVENT_CLICKED) {
        _ui_flag_modify(ui_ContainerMsgBox10, LV_OBJ_FLAG_HIDDEN, _UI_MODIFY_FLAG_ADD);
    }
}
void ui_event_Button29(lv_event_t * e)
{
