...
void ui_MainScreen_screen_init(void)
{
    ...
    lv_obj_set_style_text_font(ui_LabelTemp, &lv_font_montserrat_20, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(ui_LabelSpeed, 178);
    ...
    lv_obj_set_x(ui_LabelPress, 178);
    ...
    lv_obj_set_style_text_font(ui_LabelPress, &lv_font_montserrat_20, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(ui_LabelNoise, 179);
    ...
    lv_obj_set_style_text_font(ui_LabelNoise, &lv_font_montserrat_20, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_width(ui_Button10, 39);
    lv_obj_set_height(ui_Button10, 34);
    lv_obj_set_x(ui_Button10, 217);
    lv_obj_set_y(ui_Button10, -140);
    lv_obj_set_align(ui_Button10, LV_ALIGN_CENTER);
    lv_obj_set_style_bg_color(ui_Button10, lv_color_hex(0x403890), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_Button10, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_color(ui_Button10, lv_color_hex(0x403890), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(ui_STATUS, 145);
    lv_obj_set_y(ui_STATUS, -133);
